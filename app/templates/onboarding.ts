    ...
    subfolders: [
      {
        ...
        subfolders: [
          ...
          {
            name: "Competências Específicas",
            description: "Detalhamento das competências",
          },
          {
            name: "Missão Visão e Valores",
            description: "Diretrizes institucionais",
          },
        ...
        subfolders: [
          {
            ...
            description: "Contatos da alta gestão",
          },
          { name: "Coordenações", description: "Contatos das coordenações" },
          {
            name: "Setores Técnicos",
            description: "Contatos dos setores especializados",
          },
          {
            name: "Canais de Atendimento",
            description: "Formas de contato com o cidadão",
          },
        ],
      },
      {
        ...
        subfolders: [
          ...
          {
            name: "Hierarquia Funcional",
            description: "Níveis de comando e subordinação",
          },
          {
          ...
          {
            name: "Fluxo Decisório",
            description: "Processo de tomada de decisões",
          },
        ],
      },
      {
        ...
        subfolders: [
          ...
          {
            name: "Decretos Regulamentadores",
            description: "Decretos de regulamentação",
          },
          {
            name: "Portarias Organizacionais",
            description: "Portarias de organização interna",
          },
      ...
      },
      {
        ...
        subfolders: [
          ...
          },
          {
            ...
            description: "Planejamento de curto prazo",
          },
          {
            name: "Cronograma de Atividades",
            description: "Programação temporal",
          },
        ...
        subfolders: [
          {
            ...
            description: "Guia de procedimentos padrão",
          },
          { name: "Fluxos de Processos", description: "Mapeamento de fluxos" },
          {
            name: "Rotinas Administrativas",
            description: "Atividades administrativas recorrentes",
          },
          {
            name: "Checklist Operacional",
            description: "Listas de verificação",
          },
        ],
      },
      {
        ...
        subfolders: [
          {
            ...
            description: "Identificação e descrição dos processos",
          },
          { name: "Padronização", description: "Estabelecimento de padrões" },
          {
            name: "Melhorias Contínuas",
            description: "Aperfeiçoamento dos processos",
          },
      ...
      },
      {
        ...
        subfolders: [
          ...
          { name: "Marcos Históricos", description: "Eventos importantes" },
          {
            ...
            description: "Documentos de gestões passadas",
          },
          {
        ...
        subfolders: [
          {
            ...
            description: "Regras de funcionamento interno",
          },
          { name: "Resoluções", description: "Decisões normativas" },
          {
            name: "Instruções Normativas",
            description: "Orientações técnicas",
          },
          {
            name: "Manuais Normativos",
            description: "Guias de normas e procedimentos",
          },
        ],
      },
      {
        ...
        subfolders: [
          {
            ...
            description: "Pesquisas e estudos técnicos",
          },
          {
            name: "Relatórios Técnicos",
            description: "Relatórios especializados",
          },
          {
            name: "Pareceres Especializados",
        ...
        subfolders: [
          {
            ...
            description: "Relação oficial de serviços",
          },
          ...
          {
            name: "Canais de Atendimento",
            description: "Formas de acesso aos serviços",
          },
        ],
      },
      {
        ...
        subfolders: [
          {
            ...
            description: "Informações para gestão",
          },
          {
      ...
      },
      {
        ...
        subfolders: [
          ...
          { name: "Parcerias", description: "Acordos de cooperação" },
          {
            ...
            description: "Relatórios de prestação de contas",
          },
      ...
      },
      {
        ...
        subfolders: [
          { name: "Lei Orçamentária", description: "Lei do orçamento anual" },
          {
            ...
            description: "Acompanhamento da execução",
          },
          {
...
const municipalSecretariats: CollectionTemplate[] = [
  {
    ...
    description:
      "Coordenação geral das políticas do município e assessoria direta ao Prefeito.",
    folders: [
      ...baseStructure,
      {
        ...
        subfolders: [
          {
            ...
            subfolders: [
              {
                name: "Compromissos Oficiais",
                description: "Eventos e reuniões institucionais",
              },
              { name: "Audiências", description: "Atendimentos ao público" },
              {
                name: "Eventos Institucionais",
                description: "Solenidades e eventos públicos",
              },
              {
                name: "Viagens Oficiais",
                description: "Deslocamentos em serviço",
              },
            ],
          },
          {
            ...
            subfolders: [
              {
                name: "Protocolo Oficial",
                description: "Normas de protocolo e etiqueta",
              },
              {
              ...
              {
                name: "Homenagens",
                description: "Cerimônias de reconhecimento",
              },
            ],
          },
          {
            ...
            subfolders: [
              { name: "Pronunciamentos", description: "Declarações públicas" },
              {
                ...
                description: "Discursos em eventos",
              },
          ...
          },
          {
            ...
            subfolders: [
              {
                name: "Articulação Legislativa",
                description: "Relacionamento com a Câmara",
              },
              {
                name: "Relações Governamentais",
                description: "Articulação intergovernamental",
              },
              {
                name: "Lideranças Comunitárias",
                description: "Diálogo com lideranças",
              },
              {
                name: "Movimentos Sociais",
                description: "Relacionamento com organizações",
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    description:
      "Representação judicial e consultoria jurídica do poder executivo municipal.",
    folders: [
      ...baseStructure,
      {
        name: "06 Jurídico",
        ...
        subfolders: [
            ...
            subfolders: [
              {
                ...
                description: "Análises jurídicas preventivas",
              },
              {
                name: "Análise de Legalidade",
                description: "Verificação de conformidade legal",
              },
              {
                name: "Orientações Jurídicas",
                description: "Direcionamentos legais",
              },
              {
                name: "Consultas Internas",
                description: "Esclarecimentos jurídicos internos",
              },
            ],
          },
          {
            ...
            subfolders: [
              {
                ...
                description: "Processos em tramitação",
              },
              {
                name: "Defesa Municipal",
                description: "Defesa dos interesses municipais",
              },
          ...
          },
          {
            ...
            subfolders: [
              {
                name: "Análise de Minutas",
                description: "Revisão de contratos e convênios",
              },
              {
                name: "Pareceres Contratuais",
                description: "Análises de instrumentos contratuais",
              },
              {
                name: "Acompanhamento de Execução",
                description: "Supervisão da execução contratual",
              },
              {
                name: "Irregularidades",
                description: "Apuração de irregularidades contratuais",
              },
            ],
          },
          {
            ...
            subfolders: [
              ...
              {
                name: "Sindicâncias",
                description: "Apurações administrativas",
              },
              {
                name: "Recursos Administrativos",
                description: "Recursos em processos administrativos",
              },
            ...
            subfolders: [
              {
                ...
                description: "Elaboração de proposições legislativas",
              },
              {
                name: "Decretos Regulamentadores",
                description: "Regulamentação de leis",
              },
              {
                name: "Consolidação Normativa",
                description: "Organização da legislação",
              },
              {
                name: "Publicações Oficiais",
                description: "Divulgação de normas",
              },
            ],
          },
          {
            ...
            subfolders: [
              {
                name: "Inscrição em Dívida Ativa",
                description: "Procedimentos de inscrição",
              },
              ...
              { name: "Parcelamentos", description: "Negociação de débitos" },
              {
                ...
                description: "Estratégias de cobrança",
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    description:
      "Articulação política e relacionamento com o poder legislativo e a sociedade civil.",
    folders: [
      ...baseStructure,
      {
            ...
            subfolders: [
              {
                ...
                description: "Relacionamento com a Câmara Municipal",
              },
              {
                name: "Governo Estadual",
                description: "Articulação com o Estado",
              },
              {
                name: "Governo Federal",
                description: "Relacionamento federal",
              },
              {
                name: "Municípios Vizinhos",
                description: "Cooperação intermunicipal",
              },
            ],
          },
          {
            ...
            subfolders: [
              {
                ...
                description: "Preparação de projetos",
              },
              {
                name: "Tramitação Legislativa",
                description: "Acompanhamento na Câmara",
              },
              {
                name: "Análise de Impacto",
                description: "Avaliação de proposições",
              },
              {
                name: "Negociação Política",
                description: "Articulação para aprovação",
              },
            ],
          },
          {
            ...
            subfolders: [
              {
                ...
                description: "Relacionamento com mídia",
              },
              { name: "Redes Sociais", description: "Comunicação digital" },
              {
                name: "Campanhas Institucionais",
                description: "Divulgação de políticas públicas",
              },
              {
                name: "Eventos de Comunicação",
                description: "Ações de divulgação",
              },
            ],
          },
          {
            ...
            subfolders: [
              {
                ...
                description: "Encontros com a população",
              },
              {
                name: "Consultas Populares",
                description: "Consultas à sociedade",
              },
              { name: "Ouvidoria", description: "Canal de comunicação direta" },
              {
                name: "Conselhos Municipais",
                description: "Apoio aos conselhos",
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    description:
      "Gestão das finanças municipais, planejamento, orçamento e coordenação de obras públicas.",
    folders: [
      ...baseStructure,
      {
        ...
        subfolders: [
          {
            ...
            subfolders: [
              {
                name: "Elaboração Orçamentária",
                description: "Preparação do orçamento anual",
              },
              {
                name: "Programação Financeira",
                description: "Planejamento de fluxo de caixa",
              },
              {
                name: "Créditos Adicionais",
                description: "Suplementações orçamentárias",
              },
            ...
            subfolders: [
              {
                ...
                description: "Registro contábil das operações",
              },
              { name: "Balancetes", description: "Demonstrativos mensais" },
              {
                name: "Demonstrativos Contábeis",
                description: "Relatórios contábeis",
              },
              {
                name: "Conciliação Bancária",
                description: "Controle de contas bancárias",
              },
            ],
          },
          {
            ...
            subfolders: [
              ...
              {
                name: "Despesas Executadas",
                description: "Acompanhamento de gastos",
              },
              {
                name: "Resultados Fiscais",
                description: "Indicadores de desempenho fiscal",
              },
              {
                name: "Limites Legais",
                description: "Monitoramento de limites constitucionais",
              },
            ],
          },
          {
            ...
            subfolders: [
              ...
              {
                name: "ITBI",
                description: "Imposto de Transmissão de Bens Imóveis",
              },
              {
                name: "Taxas Municipais",
                description: "Demais tributos municipais",
              },
            ],
          },
          {
            ...
            subfolders: [
              {
                ...
                description: "Controle de fluxo financeiro",
              },
            ...
            subfolders: [
              {
                ...
                description: "Elaboração de projetos",
              },
              {
                name: "Licitações de Obras",
              ...
              },
              {
                ...
                description: "Verificação de padrões",
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    description:
      "Gestão do sistema de ensino municipal, desenvolvimento educacional e formação cidadã.",
    folders: [
      ...baseStructure,
      {
        ...
        subfolders: [
          {
            ...
            subfolders: [
              {
                name: "Currículo Municipal",
                description: "Base curricular local",
              },
              {
              ...
              },
              {
                ...
                description: "Sistemas de avaliação",
              },
              {
            ...
            subfolders: [
              {
                ...
                description: "Prédios e equipamentos",
              },
              {
                name: "Recursos Materiais",
                description: "Material didático e pedagógico",
              },
              {
                name: "Manutenção de Prédios",
                description: "Conservação das unidades",
              },
              {
                name: "Segurança Escolar",
                description: "Proteção do ambiente escolar",
              },
            ],
          },
          {
            ...
            subfolders: [
              {
                name: "Programas Federais",
                description: "PNAE, PNATE, PDDE, etc.",
              },
              {
                name: "Programas Estaduais",
                description: "Parcerias com o Estado",
              },
              { name: "Projetos Especiais", description: "Iniciativas locais" },
              {
                name: "Educação Inclusiva",
                description: "Atendimento à diversidade",
              },
            ],
          },
          {
            ...
            subfolders: [
              {
                name: "Corpo Docente",
                description: "Professores e especialistas",
              },
              {
                name: "Equipe de Apoio",
                description: "Funcionários administrativos",
              },
              {
                name: "Capacitação Profissional",
                description: "Desenvolvimento de competências",
              },
              {
                name: "Plano de Carreira",
                description: "Progressão funcional",
              },
            ],
          },
          {
            ...
            subfolders: [
              {
                ...
                description: "Cardápios e distribuição",
              },
              {
                name: "Nutrição Escolar",
                description: "Orientação nutricional",
              },
              {
                name: "Controle de Qualidade",
                description: "Qualidade dos alimentos",
              },
              {
                name: "Agricultura Familiar",
                description: "Compras da agricultura local",
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    description:
      "Gestão do sistema de saúde municipal, promoção, prevenção e assistência à saúde.",
    folders: [
      ...baseStructure,
      {
        ...
        subfolders: [
          {
            ...
            subfolders: [
              ...
              {
                name: "Promoção da Saúde",
                description: "Ações preventivas e educativas",
              },
            ],
          },
          {
            ...
            subfolders: [
              {
                ...
                description: "Atenção à saúde feminina",
              },
              {
                name: "Saúde da Criança",
                description: "Pediatria e puericultura",
              },
              {
                name: "Saúde do Idoso",
                description: "Atenção ao envelhecimento",
              },
              {
                name: "Saúde Mental",
                description: "CAPS e atenção psicossocial",
              },
            ],
          },
          {
            ...
            subfolders: [
              {
                ...
                description: "Controle de doenças",
              },
              {
                name: "Vigilância Sanitária",
                description: "Fiscalização sanitária",
              },
              {
                name: "Controle de Endemias",
                description: "Combate a vetores",
              },
          ...
          },
          {
            ...
            subfolders: [
              ...
              },
              {
                ...
                description: "Cirurgias eletivas e urgentes",
              },
              {
                name: "Diagnósticos Especializados",
                description: "Exames complexos",
              },
            ...
            subfolders: [
              {
                ...
                description: "Regulação de acesso",
              },
              { name: "Fila de Cirurgias", description: "Gestão cirúrgica" },
              {
                name: "Consultas Especializadas",
                description: "Agendamento especializado",
              },
              {
                name: "Transporte Sanitário",
  ...
  },
  {
    ...
    description:
      "Desenvolvimento de políticas de assistência social e proteção às famílias em vulnerabilidade.",
    folders: [
      ...baseStructure,
      {
        ...
        subfolders: [
          {
            ...
            subfolders: [
              {
                name: "CRAS",
                description: "Centros de Referência de Assistência Social",
              },
              {
                name: "PAIF",
                description:
              ...
              {
                name: "Benefícios Eventuais",
                description: "Auxílios emergenciais",
              },
            ],
          },
          {
          ...
          },
          {
            ...
            subfolders: [
              { name: "Cadastramento", description: "Inclusão no CadÚnico" },
              {
                ...
                description: "Manutenção de dados",
              },
              {
                name: "Gestão de Benefícios",
                description: "Acompanhamento de beneficiários",
              },
            ...
            subfolders: [
              {
                ...
                description: "Média e alta complexidade",
              },
              {
                name: "CREAS",
                description: "Centro de Referência Especializado",
              },
              {
                name: "Violação de Direitos",
                description: "Atendimento a violações",
              },
              {
          ...
          },
          {
            ...
            subfolders: [
              {
                name: "Programas de Alimentação",
                description: "Distribuição de alimentos",
              },
              {
                name: "Banco de Alimentos",
                description: "Arrecadação e distribuição",
              },
              {
                name: "Hortas Comunitárias",
                description: "Agricultura urbana",
              },
              {
                name: "Educação Nutricional",
                description: "Orientação alimentar",
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    description:
      "Proteção ambiental, licenciamento e promoção do desenvolvimento sustentável.",
    folders: [
      ...baseStructure,
      {
        ...
        subfolders: [
          {
            ...
            subfolders: [
              ...
              {
                name: "Estudos de Impacto",
                description: "Avaliação ambiental",
              },
              {
                name: "Monitoramento Ambiental",
                description: "Acompanhamento de condicionantes",
              },
          ...
          },
          {
            ...
            subfolders: [
              {
                name: "Fiscalização Preventiva",
                description: "Ações educativas",
              },
              { name: "Autuações", description: "Penalidades ambientais" },
              {
                name: "Embargo e Interdição",
                description: "Medidas de urgência",
              },
              {
                name: "Recuperação de Áreas",
                description: "Restauração ambiental",
              },
            ],
          },
          {
            ...
            subfolders: [
              {
                ...
                description: "Ações de educação ambiental",
              },
              {
                name: "Capacitação",
                description: "Formação de multiplicadores",
              },
              { name: "Campanhas", description: "Mobilização social" },
              {
                name: "Parcerias Educacionais",
                description: "Cooperação institucional",
              },
            ],
          },
          {
            ...
            subfolders: [
              ...
              {
                name: "Biodiversidade",
                description: "Conservação da fauna e flora",
              },
              {
              ...
              },
              {
                ...
                description: "Gestão do verde urbano",
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    description:
      "Comunicação institucional, imprensa e relacionamento com a mídia.",
    folders: [
      ...baseStructure,
      {
        ...
        subfolders: [
          ...
          },
          {
            ...
            subfolders: [
              {
                name: "Redes Sociais",
                description: "Gestão de perfis oficiais",
              },
              {
                name: "Portal Municipal",
                description: "Site oficial da prefeitura",
              },
          ...
          },
          {
            ...
            subfolders: [
              {
                name: "Textos Jornalísticos",
                description: "Matérias e reportagens",
              },
              { name: "Material Gráfico", description: "Peças publicitárias" },
              { name: "Audiovisual", description: "Vídeos e podcasts" },
              {
                name: "Fotografia",
                description: "Registro fotográfico oficial",
              },
            ],
          },
          {
            ...
            subfolders: [
              {
                ...
                description: "Organização logística",
              },
...
const superintendencias: CollectionTemplate[] = [
  {
    ...
    description:
      "Gestão de pessoal e desenvolvimento de recursos humanos municipais.",
    folders: [
      ...baseStructure,
      {
            ...
            subfolders: [
              {
                ...
                description: "Dados dos servidores",
              },
              {
                name: "Movimentação",
                description: "Transferências e remoções",
              },
              { name: "Progressões", description: "Avanços na carreira" },
              {
                name: "Aposentadorias",
                description: "Processos de aposentadoria",
              },
            ],
          },
          {
          ...
          },
          {
            ...
            subfolders: [
              { name: "Treinamentos", description: "Cursos e capacitações" },
              {
                ...
                description: "Formação permanente",
              },
              {
  ...
  },
  {
    ...
    description:
      "Gestão de tecnologia, sistemas e infraestrutura digital municipal.",
    folders: [
      ...baseStructure,
      {
        ...
        subfolders: [
          ...
          },
          {
            ...
            subfolders: [
              {
                name: "Sistemas Municipais",
                description: "Aplicações próprias",
              },
            ...
            subfolders: [
              {
                ...
                description: "Normas de proteção",
              },
              {
  ...
  },
  {
    ...
    description:
      "Gestão de compras, licitações e contratos administrativos municipais.",
    folders: [
      ...baseStructure,
      {
        ...
        subfolders: [
          {
            ...
            subfolders: [
              { name: "Plano Anual", description: "Programação de compras" },
              {
                ...
                description: "Levantamento de mercado",
              },
              {
                name: "Especificações Técnicas",
                description: "Definição de requisitos",
              },
...
const conselhos: CollectionTemplate[] = [
  {
    ...
    description:
      "Órgão de controle social e consultivo do sistema municipal de ensino.",
    folders: [
      ...baseStructure,
      {
        ...
        subfolders: [
          {
            ...
            subfolders: [
              {
                name: "Representação Governamental",
                description: "Membros do governo",
              },
              {
                name: "Representação da Sociedade Civil",
                description: "Membros da sociedade",
              },
              {
                name: "Mandato dos Conselheiros",
                description: "Período de atuação",
              },
          ...
          },
          {
            ...
            subfolders: [
              {
                name: "Acompanhamento de Políticas",
                description: "Monitoramento de ações",
              },
              {
                name: "Controle de Recursos",
                description: "Fiscalização financeira",
              },
              {
                name: "Avaliação de Programas",
  ...
  },
  {
    ...
    description:
      "Órgão colegiado de controle social do Sistema Único de Saúde no município.",
    folders: [
      ...baseStructure,
      {
            ...
            subfolders: [
              {
                ...
                description: "Normas de funcionamento",
              },
              {
                name: "Reuniões Plenárias",
                description: "Encontros do conselho",
              },
              { name: "Comissões Técnicas", description: "Grupos de trabalho" },
              {
                name: "Calendário de Reuniões",
                description: "Programação anual",
              },
            ],
          },
          {
            ...
            subfolders: [
              {
                ...
                description: "Acompanhamento do planejamento",
              },
              {
              ...
              {
                name: "Aplicação de Recursos",
                description: "Controle financeiro",
              },
              {
                name: "Conferências Municipais",
                description: "Eventos participativos",
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    description:
      "Órgão superior de deliberação, normatização e controle das ações de assistência social.",
    folders: [
      ...baseStructure,
      {
        ...
        subfolders: [
            ...
            subfolders: [
              {
                ...
                description: "Aprovação do planejamento",
              },
              {
                name: "Programas e Projetos",
                description: "Análise de propostas",
              },
              {
                name: "Critérios de Partilha",
          ...
          },
          {
            ...
            subfolders: [
              {
                name: "Inscrição de Entidades",
                description: "Cadastro no CMAS",
              },
              {
                name: "Certificação",
                description: "Certificado de Entidade Beneficente",
              },
...
const autarquias: CollectionTemplate[] = [
  {
    ...
    description:
      "Autarquia municipal responsável por obras, serviços urbanos e gestão de trânsito.",
    folders: [
      ...baseStructure,
      {
          ...
          },
          {
            ...
            subfolders: [
              ...
              { name: "Drenagem", description: "Sistema de escoamento" },
              {
                ...
                description: "Manutenção da iluminação",
              },
            ...
            subfolders: [
              {
                ...
                description: "Placas e semáforos",
              },
              { name: "Fiscalização", description: "Controle de trânsito" },
              {
                name: "Educação para o Trânsito",
                description: "Campanhas educativas",
              },
  ...
  },
  {
    ...
    description:
      "Unidade hospitalar municipal de referência para média e alta complexidade.",
    folders: [
      ...baseStructure,
      {
        ...
        subfolders: [
          ...
          },
          {
            ...
            subfolders: [
              {
                name: "Consultas Especializadas",
                description: "Ambulatórios médicos",
              },
              {
                name: "Diagnóstico por Imagem",
                description: "Exames radiológicos",
              },
          ...
          },
          {
            ...
            subfolders: [
              {
                name: "Qualidade Assistencial",
                description: "Protocolos e indicadores",
              },
              {
                name: "Segurança do Paciente",
                description: "Prevenção de eventos adversos",
              },
              {
                name: "Hotelaria Hospitalar",
                description: "Serviços de apoio",
              },
              {
                name: "Gestão de Leitos",
                description: "Ocupação e rotatividade",
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    description:
      "Entidade de assistência social voltada para proteção materno-infantil e idosos.",
    folders: [
      ...baseStructure,
      {
        ...
        subfolders: [
          {
            ...
            subfolders: [
              {
                name: "Pré-Natal Social",
                description: "Acompanhamento social",
              },
              {
                name: "Apoio à Gestante",
                description: "Orientação e assistência",
              },
              { name: "Puerpério", description: "Cuidados pós-parto" },
              {
                name: "Planejamento Familiar",
                description: "Orientação reprodutiva",
              },
            ],
          },
          {
            ...
            subfolders: [
              { name: "Primeira Infância", description: "0 a 6 anos" },
              {
                ...
                description: "Estimulação e cuidados",
              },
              {
                name: "Proteção de Direitos",
                description: "Garantia de direitos",
              },
              {
                name: "Convivência Familiar",
                description: "Fortalecimento de vínculos",
              },
            ],
          },
          {
            ...
            subfolders: [
              ...
              {
                name: "Assistência Domiciliar",
                description: "Cuidados em casa",
              },
              {
                name: "Proteção Especial",
                description: "Situações de vulnerabilidade",
              },
              {
                name: "Envelhecimento Ativo",
                description: "Promoção da autonomia",
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    description:
      "Fundação municipal para desenvolvimento de pesquisa, tecnologia e inovação.",
    folders: [
      ...baseStructure,
      {
            ...
            subfolders: [
              {
                ...
                description: "Estudos e desenvolvimento",
              },
              {
              ...
              {
                name: "Parcerias Acadêmicas",
                description: "Cooperação com universidades",
              },
              {
                name: "Propriedade Intelectual",
                description: "Patentes e registros",
              },
            ],
          },
          {
            ...
            subfolders: [
              {
                name: "Soluções Municipais",
                description: "Tecnologia para a gestão pública",
              },
              {
                name: "Capacitação Tecnológica",
              ...
              {
                name: "Incubação de Projetos",
                description: "Apoio a startups",
              },
            ],
          },
          {
            ...
            subfolders: [
              {
                ...
                description: "Infraestrutura científica",
              },
              {
                name: "Equipamentos Especializados",
                description: "Instrumentação científica",
              },
              {
                name: "Biblioteca Técnica",
                description: "Acervo especializado",
              },
              {
                name: "Espaços de Coworking",
                description: "Ambientes colaborativos",
              },
            ],
          },
        ],
...
const estadualSecretariats: CollectionTemplate[] = [
  {
    ...
    description:
      "Coordenação da secretaria estadual e assessoria direta ao Secretário.",
    folders: [
      ...baseStructure,
      {
        ...
        subfolders: [
          {
            ...
            subfolders: [
              ...
              { name: "Audiências", description: "Atendimentos ao público" },
              {
                name: "Eventos Intergovernamentais",
                description: "Articulação federativa",
              },
            ...
            subfolders: [
              {
                ...
                description: "Diretrizes de médio e longo prazo",
              },
              {
                name: "Monitoramento de Metas",
                description: "Acompanhamento de resultados",
              },
              {
                name: "Articulação Interna",
                description: "Coordenação entre órgãos",
              },
              {
                name: "Relações Institucionais",
                description: "Parcerias e cooperação",
              },
            ],
          },
        ],
        ...
        subfolders: [
          {
            ...
            subfolders: [
              {
                name: "Pareceres Consultivos",
                description: "Orientações jurídicas preventivas",
              },
              {
                name: "Análise de Constitucionalidade",
                description: "Verificação constitucional",
              },
              {
                name: "Interpretação Legal",
                description: "Esclarecimentos normativos",
              },
              {
                name: "Consultas Complexas",
                description: "Questões jurídicas especializadas",
              },
            ],
          },
          {
            ...
            subfolders: [
              {
                name: "Orientações Normativas",
                description: "Diretrizes de aplicação",
              },
              {
                name: "Procedimentos Legais",
                description: "Rotinas jurídicas",
              },
              { name: "Jurisprudência", description: "Compilação de decisões" },
              {
                name: "Doutrina Aplicada",
          ...
          },
          {
            ...
            subfolders: [
              {
                name: "Propostas Legislativas",
                description: "Análise de projetos de lei",
              },
              {
                name: "Impacto Regulatório",
                description: "Avaliação de efeitos normativos",
              },
              {
                name: "Constitucionalidade",
                description: "Verificação constitucional",
              },
              {
                name: "Harmonização Normativa",
                description: "Compatibilização legal",
              },
            ],
          },
        ],
        ...
        subfolders: [
          {
            ...
            subfolders: [
              {
                name: "Compromissos Nacionais",
                description: "Eventos em território nacional",
              },
              {
                name: "Compromissos Internacionais",
                description: "Agenda internacional",
              },
              {
                name: "Reuniões Ministeriais",
                description: "Encontros com outros ministros",
              },
              {
                name: "Audiências Oficiais",
                description: "Atendimentos protocolares",
              },
            ],
          },
          {
            ...
            subfolders: [
              {
                name: "Discursos Oficiais",
                description: "Pronunciamentos ministeriais",
              },
              {
                name: "Portarias Ministeriais",
                description: "Atos normativos do ministério",
              },
              {
                name: "Instruções Normativas",
                description: "Orientações técnicas",
              },
              {
                ...
                description: "Informações à sociedade",
              },
            ],
          },
          {
            ...
            subfolders: [
              {
                name: "Articulação Federativa",
                description: "Relação com estados e municípios",
              },
              {
                name: "Coordenação Interministerial",
                description: "Articulação entre ministérios",
              },
              {
                name: "Relações Internacionais",
                description: "Cooperação internacional",
              },
        ...
        subfolders: [
          {
            ...
            subfolders: [
              {
                name: "Pareceres de Alto Nível",
                description: "Análises jurídicas complexas",
              },
              {
                name: "Notas Técnicas Federais",
                description: "Orientações especializadas",
              },
              {
                name: "Interpretação Constitucional",
                description: "Análises constitucionais",
              },
              {
                name: "Direito Internacional",
                description: "Questões internacionais",
              },
            ],
          },
          {
            ...
            subfolders: [
              {
                name: "Projetos de Lei Federal",
                description: "Análise de PLs",
              },
              {
                name: "Medidas Provisórias",
                description: "Acompanhamento de MPs",
              },
              { name: "Decretos Federais", description: "Análise de decretos" },
              {
                name: "Regulamentação",
                description: "Elaboração de normas regulamentadoras",
              },
            ],
          },
          {
            ...
            subfolders: [
              { name: "Supremo Tribunal Federal", description: "Ações no STF" },
              {
                ...
                description: "Recursos ao STJ",
              },
              {
                name: "Tribunais Regionais Federais",
                description: "Ações nos TRFs",
              },
              {
                name: "Advocacia-Geral da União",
                description: "Articulação com AGU",
              },
            ],
          },
        ],
    ...
    folders: [
      {
        ...
        subfolders: [
          ...
          {
            name: "ESF - Estratégia Saúde da Família",
            description: "Equipes de saúde da família",
          },
          {
            name: "NASF - Núcleo de Apoio",
            description: "Apoio às equipes básicas",
          },
          {
            name: "Academia da Saúde",
            description: "Promoção de atividade física",
          },
        ],
      },
      {
        ...
        subfolders: [
          {
            name: "Ambulatórios Especializados",
            description: "Consultas especializadas",
          },
          {
          ...
          {
            name: "CEO - Centro de Especialidades Odontológicas",
            description: "Odontologia especializada",
          },
          {
    ...
    folders: [
      {
        ...
        subfolders: [
          ...
          {
            name: "PAIF",
            description: "Proteção e Atendimento Integral à Família",
          },
          {
            name: "SCFV",
          ...
          {
            name: "Centro de Convivência",
            description: "Espaços de socialização",
          },
        ],
      },
      {
...
export function generateCompleteStructure(
  orgType: keyof typeof orgTemplates,
  orgName: string
): any {
...
export const CONFIG = {
  MAX_FOLDER_DEPTH: 4,
  REQUIRED_BASE_FOLDERS: [
    "00 Institucional",
    "01 Gestão",
    "02 Documentos",
    "03 Serviços",
    "04 Dados e Informações",
    "05 Transparência",
  ],
...
export function validateStructure(structure: CollectionTemplate[]): {
  valid: boolean;
  errors: string[];
} {
  const errors: string[] = [];
  ...
  structure.forEach((collection) => {
    ...
    if (!hasRequiredFolders) {
      errors.push(
        `Coleção ${collection.name} não possui todas as pastas base obrigatórias`
      );
    }
    ...
    collection.folders.forEach((folder) => {
      if (folder.name.length > CONFIG.MAX_FOLDER_NAME_LENGTH) {
        errors.push(
          `Nome da pasta "${folder.name}" excede o limite de caracteres`
        );
      }

      const hasInvalidChars = CONFIG.FORBIDDEN_CHARACTERS.some((char) =>
        folder.name.includes(char)
      );
      if (hasInvalidChars) {
        errors.push(
          `Nome da pasta "${folder.name}" contém caracteres inválidos`
        );
      }
    });
  });
